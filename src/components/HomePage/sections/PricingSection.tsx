...
{/*
     ...
     <main class="max-w-6xl mx-auto pt-10 pb-36 px-8 bg-amber-200">
      ...
      >
          ...
          <div class="ml-5">
            ...
            <span
              ><span class="font-medium text-gray-500 text-xl align-top"
                >$&thinsp;</span
              ><span class="text-3xl font-bold">10 </span></span
        ...
        <ul class="mb-7 font-medium text-gray-500">
          <li class="flex text-lg mb-2">
            ...
            />
            <span class="ml-3"
              >Get started with <span class="text-black">messaging</span></span
            >
          </li>
          <li class="flex text-lg mb-2">
            <img
            ...
            />
            <span class="ml-3"
              >Flexible <span class="text-black">team meetings</span></span
            >
          </li>
          <li class="flex text-lg">
            ...
            />
            <span class="ml-3"
              ><span class="text-black">5 TB</span> cloud storage</span
            >
          </li>
        </ul>
        <a
      ...
      >
        <div class="mb-8 pb-8 flex items-center border-b border-gray-600">
          ...
          <div class="ml-5">
            ...
            <span
              ...
              ><span class="text-3xl font-bold text-white">24 </span></span
        ...
        <ul class="mb-10 font-medium text-xl">
          <li class="flex mb-6">
            ...
            />
            <span class="ml-3"
              >All features in <span class="text-white">Basic</span></span
            >
          </li>
          <li class="flex mb-6">
            <img
            ...
            />
            <span class="ml-3"
              >Flexible <span class="text-white">call scheduling</span></span
            >
          </li>
          <li class="flex">
            <img
            ...
            />
            <span class="ml-3"
              ><span class="text-white">15 TB</span> cloud storage</span
            >
          </li>
        </ul>
        <a
        ...
        <div class="mb-7 pb-7 flex items-center border-b border-gray-300">
          ...
          <div class="ml-5">
            ...
            <span
              ><span class="font-medium text-gray-500 text-xl align-top"
                >$&thinsp;</span
              ><span class="text-3xl font-bold">35 </span></span
            ><span class="text-gray-500 font-medium">/ user</span>
          </div>
        </div>
        <ul class="mb-7 font-medium text-gray-500">
          <li class="flex text-lg mb-2">
            ...
            />
            <span class="ml-3"
              >All features in <span class="text-black">Startup</span></span
            >
          </li>
          <li class="flex text-lg mb-2">
            <img
            ...
            />
            <span class="ml-3"
              >Growth <span class="text-black">oriented</span></span
            >
          </li>
          <li class="flex text-lg">
            <img
            ...
            />
            <span class="ml-3"
              ><span class="text-black">Unlimited</span> cloud storage</span
            >
          </li>
        </ul>
        <a
