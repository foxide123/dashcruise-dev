...
export default function ExclusivePlan() {
  return (
    <div className="lg:w-136 lg:h-102 lg:my-0 w-[75vw] my-5 bg-blur-500/90 backdrop-blur-md p-6 rounded-[1.25rem] flex items-center justify-center text-white border-[1px] border-carrot-600">
      <div>
        ...
        <button className="bg-carrot-500 rounded-xl py-4 px-5 w-full text-center mt-5">
          Book Now
        </button>
      </div>
    </div>
