...
export default function NavBar({
  ...
  return (
    <nav
      className={` sm:flex ${lg_screen_width} ${default_screen_width} bg-navbar backdrop-blur-md text-white h-[98px] my-[48px] rounded-4xl flex-row justify-between   hidden`}
    >
